...
@implementation LDUnlimitScrollView

+(instancetype)unlimitScrollView
{
  return  [[[NSBundle mainBundle]loadNibNamed:@"LDUnlimitScrollView" owner:nil options:nil]lastObject];
}
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UIImage * image  = self.itemsList[indexPath.item];
